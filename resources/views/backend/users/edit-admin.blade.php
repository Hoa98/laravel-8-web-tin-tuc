...
<div class="card">
   ...
   <div class="row">
       ...
       <div class="col-6">
        <div class="form-group">
            ...
            <select name="role" id="" class="form-control">
                ...
                <option value="2" @if(Auth::user()->role == 2) selected @endif>Người dùng</option>
                <option value="1" @if(Auth::user()->role==1) selected @endif>Quản trị</option>
            </select>
            @if($errors->has('role'))
        ...
        <div class="form-group">
            ...
            <img id="previewImg" src="{{asset(Auth::user()->avatar)}}" style="max-width:130px; margin-top:20px;"/>
    ...
    <form action="{{route('admin.resetPass')}}" class="collapse form-contact mt-3 needs-validation @if($errors->has('password') || $errors->has('res_pass') || $errors->has('confirm_pass'))  show @endif" id="resetPass" method="post">
        @csrf
       <div class="row">
